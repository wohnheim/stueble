...
|  Termine für Anmeldung Sicht Tutoren: /tutoren/stueble/dates: GET Liste aus allen Daten + UUID | DONE |
|  Zu 6. POST zum Speichern der Auswahl mit Dict mit key: Datum, value uuid der Bewerbung | DONE |
...
|  Auswahl-Tabelle (geshared unter Tutoren) | DONE |
|  Ggf. Tabelle mit persistenten Änderungen der Stüble Auswahl (finale Auswahl) | DONE |

2 Hauptverantwortliche für Bewerbung auf Stüble